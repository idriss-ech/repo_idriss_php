 ...
 */
 ...
 interface ConfigurationInterface
 {
     ...
     * 
     * @psalm-parm non-empy-string $key 
     * 
     * @return mixed
     * 
     * @throws ValidationException if the schema failed to validate the given input
     * @throws UnknownOptionException if the requested key does not exist of is malformed
     * 
     * 
     */
     ...
     /**
      * @param string $key configuratin option path/key 
      * 
