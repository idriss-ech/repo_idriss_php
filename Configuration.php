     ...
     */
      ...
      */
       ...
       */
       ...
       public function addSchema(string $key, Schema $schema):variant_mod{
        $this->invalidate();
         ...
         */
          ...
          */
           ...
           */
           ...
           public function exists(string $key):boolval{
            if(\array_key_exists($key, $this->cache)){
                return true;
            }
            try{
            ...
            */
             ...
             */
             ...
             /**
              * Applies the schema against the confugration to return the final configuration 
              *
              * @throws ValidatinException | UnknownOptionException|InvalidPathException
              *
              * @psalm-allow-private-mutation
              */
              ...
              private function build(string $topLevelKey):void 
              {
                ...
                try{
                    ...
                    $this->raiseAnyDeprecationNotice($processor->getWarnings());
